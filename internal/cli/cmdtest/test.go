...
in a spec file generated by 'forge test spec'.
...
`),
	...
	runCmd.Flags().StringVar(&runSpecPath, "spec", "", "path to spec.yml generated by `forge test spec <feature>`")
	...
	parent.AddCommand(createCmd, approveCmd, runCmd, ciCmd, newSpecCmd(), newManualCmd())
